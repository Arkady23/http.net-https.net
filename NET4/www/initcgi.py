...
#    путем.
# 3. Далее следуют пары строк заголовков: строка с наименованием
#    и строка со значением.
# 4. Весь остальной поток в стандартном вводе проходит скрипту-
#    обработчику без изменений.
